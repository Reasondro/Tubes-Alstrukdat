...
/* Implementasi Queue menggunakan circular Tab (Alternatif III) */
...
typedef struct {
        songtype Tab[IDX_MAX+1];  /* tabel penyimpan elemen */
...
/* F.S. mengembalikan nilai Q pada idxHead;
        Head "maju" dengan mekanisme circular Tab;
        Q mungkin kosong */

/* *** Display Queue *** */
void displayQueue(Queue q);
/* Proses : Menuliskan isi Queue dengan traversal dan mekanisme circular Tab;
